 ...
 return (  
    <div> 
      <nav className="navbar navbar-expand-lg bg-light">
            <ul className="nav nav-tabs" role="tablist">
                <li className="nav-item" role="presentation">
                    <a className="nav-link active" data-bs-toggle="tab" aria-selected="true" role="tab" href="#divusuario">{props.item1Text}</a>                 
                </li>
                <li className="nav-item" role="presentation">
                    <a className="nav-link" data-bs-toggle="tab" href="#divalbums" aria-selected="false" role="tab" tabIndex="-1">{props.item2Text}</a>
                </li>
                <li className="nav-item" role="presentation">
                    <a className="nav-link" data-bs-toggle="tab" href="#divpost" aria-selected="false" role="tab" tabIndex="-1">{props.item3Text}</a>
                </li>
                <li className="nav-item" role="presentation">
                    <a className="nav-link" data-bs-toggle="tab" href="#divtodos" aria-selected="false" role="tab" tabIndex="-1">{props.item4Text}</a>
                </li>
            </ul>
      </nav>
      ...
      <div id="myTabContent" className="tab-content">
        <div className="tab-pane fade active show" id="divusuario" role="tabpanel">
           <Users />
        </div>
